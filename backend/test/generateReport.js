// This script collects test results from functional, persona assignment, and PII detection tests
// and generates a comprehensive markdown report summarizing the findings, performance metrics
// and recommendations for the privacy-aware chatbot system.
...
const report = `# Testing Evaluation Report
...
**Recommendation:** System is suitable for study deployment with documented limitations disclosed to participants.

**Approval Status:** Approved for study
...
const reportPath = path.join(__dirname, "../test-results/evaluation-report.md");
